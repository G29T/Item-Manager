...
export const loadItemsByUserSuccess = createAction(
    '[Item] Load Items By User Success', 
    props<{ items: Item[] }>()
);

export const loadItemsByUserFailure = createAction(
    '[Item] Load Items By User Failure', 
    props<{ error: any }>()
);
